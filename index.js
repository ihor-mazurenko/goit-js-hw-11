        ...
        <li class="gallery-item">
            ...
            <div class="image-info-wrapper">
                <div class="image-info-container">
                    ...
                    <span class="image-info-container-value">${a.likes}</span>                
                </div>

                <div class="image-info-container">
                    <span class="image-info-container-type">Views</span>
                    <span class="image-info-container-value">${a.views}</span>                
                </div>

                <div class="image-info-container">
                    <span class="image-info-container-type">Comments</span>
                    <span class="image-info-container-value">${a.comments}</span>                
                </div>

                <div class="image-info-container">
                    <span class="image-info-container-type">Downloads</span>
                    <span class="image-info-container-value">${a.downloads}</span>                
                </div>
            </div>
        </li>
    `).join("");c.insertAdjacentHTML("beforeend",t),C.refresh()}const l=document.querySelector(".form"),b=document.querySelector("input[name='search-text']");l.addEventListener("submit",n=>{n.preventDefault();const t=b.value.trim();if(t===""){s.show({title:"Caution",titleColor:"#fff",titleSize:"16px",titleLineHeight:"1.5",message:"Not valid data",messageColor:"#fff",messageSize:"16px",messageLineHeight:"1.5",backgroundColor:"#ffa000",iconUrl:cautionIcon,progressBar:!1,position:"topRight"});return}v(),y(),u(t).then(a=>{w(a)}).catch(()=>{s.show({message:"Something went wrong. Please try again later.",messageColor:"#fafafb",messageSize:"16px",messageLineHeight:"20px",backgroundColor:"#ef4040",iconUrl:warningIcon,progressBar:!1,position:"topRight"})}).finally(()=>{L(),l.reset()})});
